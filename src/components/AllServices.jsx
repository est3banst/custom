...
const AllServices = () => {
  ...
  const { ref:ref4, inView: inView4 } = useInView({ threshold: 0.1 });
            ...
            <div className='h-auto pt-[80px] relative flex gap-6 justify-evenly p-4 flex-col'>
                <section className='w-full lg:grid lg:grid-cols-3 my-3'>
                    ...
                    <div className='lg:block flex gap-2 flex-col items-center'>
                        <p className='text-base self-start border-b-2 border-slate-50 w-max my-4 md:text-xl'>
                            Obtendrás:
                        </p>
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg
                    ...
                    <div className='lg:block flex gap-2 flex-col items-center'>
                        <h2 className='self-start text-base md:text-xl border-b-2 border-slate-50 w-max my-4'>
                ...
                <section className='w-full lg:grid lg:grid-cols-3 my-3'>
                    <article className='md:flex w-5/6 md:flex-col md:justify-center'>
                        ...
                        <div ref={ref2} className={`load-custom-bord transition-all duration-[320ms] ${inView2 ? 'startAnim' : ''}`}></div>

                    </article>
                    <div className='lg:block flex flex-col gap-2 items-center'>
                        <p className='self-start border-b-2 border-slate-50 w-max my-4 text-base md:text-xl'>
                            Obtendrás:
                        </p>
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            ...
                            <div className='h-auto backdrop-blur-md m-auto bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] fill-amber-50 w-[55px] m-auto md:w-[80px] border-b-[0.5px] border-slate-50" viewBox="0 0 32 32">
                    ...
                    <div className='lg:block flex flex-col items-center'>
                        <h2 className='self-start border-b-2 border-slate-50 w-max my-4 text-base md:text-xl'>

                            Impacto en el negocio:
                        </h2>
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] m-auto fill-amber-50 border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 32 32">
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] m-auto fill-none border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                ...
                <section className='w-full lg:grid lg:grid-cols-3 my-3'>
                    <article className='md:flex w-5/6 md:flex-col   md:justify-center'>
                        ...
                        <div ref={ref3} className={`load-custom-bord transition-all duration-[320ms] ${inView3 ? 'startAnim' : ''}`}></div>
                    ...
                    <div className='lg:block flex gap-2 flex-col items-center'>
                        ...
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] m-auto fill-amber-50 border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className=" border-b-[0.5px] m-auto border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="border-b-[0.5px] m-auto fill-amber-50 hover:fill-[#a78bfa] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 32 32">
                                    <path   d="M16 27c-3.6 0-7.1-1.8-9.2-5H12v-2H4v8h2v-3.7c2.5 3 6.1 4.7 10 4.7zm15-4v-2h-2.1c-.1-.6-.4-1.2-.7-1.8l1.5-1.5l-1.4-1.4l-1.5 1.5c-.5-.3-1.1-.6-1.8-.7V15h-2v2.1c-.6.1-1.2.4-1.8.7l-1.5-1.5l-1.4 1.4l1.5 1.5c-.3.5-.6 1.1-.7 1.8H17v2h2.1c.1.6.4 1.2.7 1.8l-1.5 1.5l1.4 1.4l1.5-1.5c.5.3 1.1.6 1.8.7V29h2v-2.1c.6-.1 1.2-.4 1.8-.7l1.5 1.5l1.4-1.4l-1.5-1.5c.3-.5.6-1.1.7-1.8zm-7 2c-1.7 0-3-1.3-3-3s1.3-3 3-3s3 1.3 3 3s-1.3 3-3 3m-4-15h5.2C21.9 4.9 15.1 3.5 10 6.8c-3.1 2-5 5.5-5 9.2H3C3 8.8 8.8 3 16 3c3.9 0 7.5 1.7 10 4.7V4h2v8h-8z"></path>
                                </svg>
                            <p className='p-2'>
                    ...
                    <div className='lg:block flex gap-2 flex-col items-center'>
                        ...
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="border-b-[0.5px] m-auto fill-amber-50 hover:fill-[#a78bfa] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 32 32">
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                ...
                <section className='w-full lg:grid lg:grid-cols-3 my-3'>
                    <article className='md:flex w-5/6 md:flex-col md:justify-center'>
                        ...
                        <div ref={ref4} className={`load-custom-bord transition-all duration-[320ms] ${inView4 ? 'startAnim' : ''}`}></div>
	...
	<path   d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5zm0 6c1.4 0 2.8 1.1 2.8 2.5V11c.6 0 1.2.6 1.2 1.3v3.5c0 .6-.6 1.2-1.3 1.2H9.2c-.6 0-1.2-.6-1.2-1.3v-3.5c0-.6.6-1.2 1.2-1.2V9.5C9.2 8.1 10.6 7 12 7m0 1.2c-.8 0-1.5.5-1.5 1.3V11h3V9.5c0-.8-.7-1.3-1.5-1.3"></path>
                        ...
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 20 20">
...
Impacto en el negocio:
                        ...
                        <section className='flex sm:w-5/6 md:w-4/6 gap-4 px-4 justify-center flex-col items-center'>
                        <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" className='hover:fill-[#a78bfa] fill-amber-50 m-auto w-[55px] md:w-[80px]' viewBox="0 0 24 24">
	...
	<path  d="M12.876 14a6.47 6.47 0 0 0-1.376 4c0 1.509.514 2.897 1.376 4H2v-2a6 6 0 0 1 6-6z"></path>
                            ...
                            <div className='h-auto backdrop-blur-md bg-[#00000020] p-6 rounded-xs w-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" className='hover:stroke-[#a78bfa] stroke-amber-50 m-auto w-[55px] md:w-[80px]' viewBox="0 0 48 48">
	...
	<circle cx={12} cy={9} r={3} className='hover:fill-[#a78bfa] fill-amber-50'></circle>
                ...
                <div className='flex w-5/6 mx-auto'>
                    ...
                    <button className='action'>Obtener soporte</button>
                </div>
                    </Link>
                <hr />
            </div>
