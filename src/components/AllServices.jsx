...
const AllServices = () => {
    ...
    const servicesAll = [
        { title : "Desarrollo de Landing Pages o Aplicaciones de una Sola Página" ,
            benefits :[
                {
                    text: 'Carga rápida y experiencia fluida para atraer más clientes',
                    svg: (<svg
                    ...
                    text: 'Diseño moderno y adaptable a todos los dispositivos',
                    svg: (<svg
                        className='hover:fill-[#a78bfa] m-auto fill-amber-50 w-[55px] md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {
                    text: 'Optimización SEO para mejorar la visibilidad en buscadores',
                    svg: (<svg
            ...
            impacts :[
                { text: 'Aumenta la conversión de visitantes en clientes',
                    svg:(<svg
                ...
                { text: 'Refuerza la identidad de marca con una web atractiva',
                    svg:(<svg
                        className=' w-[55px] m-auto md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                { text: 'Mejora la comunicación directa con la audiencia',
                    svg:(<svg
                        className='hover:fill-[#a78bfa] m-auto fill-amber-50 w-[55px] md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        {
            title: 'Desarrollo e Implementación de E-commerce',
            benefits: [
                {
                    text: 'Plataforma segura y escalable para ventas en línea',
                ...
                {
                    text: 'Integración con métodos de pago y gestión de envíos',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" 
                ...
                {
                    text: 'Diseño intuitivo que facilita la compra y fideliza clientes',
            ...
            impacts: [
                {
                    text: 'Expansión del mercado y aumento de ventas',
                ...
                {
                    text: 'Automatización de procesos para mayor eficiencia',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] m-auto fill-amber-50 border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 32 32">
                ...
                {
                    text: 'Disponibilidad 24/7 para generar ingresos constantes',
        ...
        {
            title: 'Gestión de Relación con el Cliente (CRM)',
            benefits: [
                {
                    text: 'Optimización de procesos internos y una gestión màs eficiente',
                ...
                {
                    text: 'Centralización de datos para mejor toma de decisiones',
                ...
                {
                    text: 'Automatización de tareas para reducir costos operativos',
            ...
            impacts: [
                {
                    text: 'Ahorro de tiempo y mejora en la productividad',
                ...
                {
                    text: 'Mayor control y análisis de datos en tiempo real',
                ...
                {
                    text: 'Facilita la escalabilidad y el crecimiento de la empresa',
            ...
            buttonText: 'Sistemas de administración',
            link: '/services/crm'
        },
        {
            title: 'Optimización Web y Soporte de Aplicaciones',
            benefits: [
                {
                    text: 'Mejoras en el rendimiento y menores tiempos de carga para evitar perdidas de clientes',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className=" fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                ...
                {
                    text: 'Seguridad mejorada para proteger datos y prevenir ataques',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className="fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                ...
                {
                    text: 'Mantenimiento y actualizaciones constantes para estabilidad',
            ...
            impacts: [
                {
                    text: 'Experiencia de usuario mejorada, aumentando la retención',
                ...
                {
                    text: 'Reducción de errores y fallos que afectan las ventas',
                ...
                {
                    text: 'Mayor confiabilidad y competitividad en el mercado',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className='hover:fill-[#a78bfa] fill-amber-50 m-auto w-[55px] md:w-[80px]' viewBox="0 0 24 24">
