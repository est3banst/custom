...
const TwistedGallery = () => {
	...
	return (
		<div className='grid grid-cols-1 md:grid-cols-2 h-auto py-4'>
			...
			<div className='relative w-full h-auto py-22 overflow-clip gap-4 flex items-center'>
				...
				<section ref={refFirst} className={`w-full flex flex-col gap-1 transition-all duration-500 ease-in-out items-center justify-center rotate-45 ${inViewFirst ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
					<article ref={refOne} className='flex w-[200%] gap-1 transition-transform duration-300 ease-out'>
						...
						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/nail-reservas.png" alt="" />
					...
					<article ref={refTwo} className='flex w-[200%] gap-4 transition-transform duration-300 ease-out'>
						<img className="w-0 grow-2 aspect-square object-cover object-center" src="/login.png" alt="" />
						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/personal-web.png" alt="" />
						<img className="w-20 grow-2 aspect-square object-cover object-center" src="/gym-web.png" alt="" />
						<img className="w-20 grow-2 aspect-square object-cover object-center" src="/nail-reservas.png" alt="" />

						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/products.png" alt="" />
						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/dental-clinic.png" alt="" />
					</article>
					<article ref={refThree} className='flex w-[200%] gap-4 transition-transform duration-300 ease-out'>
						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/gym-web.png" alt="" />
						<img className="w-0 grow-1 aspect-square object-cover object-center" src="/nail-reservas.png" alt="" />

						<img className="w-0 grow-2 aspect-square object-cover object-center" src="/personal-web.png" alt="" />

						<img className="w-20 grow-3 aspect-square object-cover object-center" src="/products.png" alt="" />
			...
			className={`flex flex-col md:px-4 justify-center transition-all duration-300 ease-in-out ${inViewFirst ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0' } `}>
