...
const ContactPage = () => {
  ...
  return (
    ...
    <section className='flex w-full h-full justify-center items-center italiana px-2 py-4 flex-col gap-8'> 
        ...
        <h2 className='font-bold px-2 text-xl py-1'>Necesitas un equipo listo para ayudarte a utilizar la tecnología para hacer crecer tu negocio?</h2>
        <p className='px-4 my-3 leading-relaxed'>Estás en el lugar indicado, dejanos un mensaje con tus datos y nos pondremos en contacto contigo!</p>
    </section>
