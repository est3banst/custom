...
import FormModalEn from './FormModalEn'
                ...
                <div className='p-4 z-20 flex relative flex-col gap-3'>
                    <div className='pt-24 px-4 relative flex flex-col gap-2'>
                        <h2 className='text-xl uppercase md:text-2xl'>
                            Why is it necessary to manage your business from an <b className='text-xl md:text-2xl px-1 text-[#a78bfa]'> administration system in </b>{currentYear}?
                        </h2>
                        <div className='h-auto backdrop-blur-md bg-[#17171720] leading-relaxed p-4 rounded-xs shadow-lg w-full'>
                            <h3 className='px-2 my-4'>
                                Technology advances rapidly and <b>your business cannot be left behind</b>. Optimize management with our CRM and take your business to the next level in 2025.
                            </h3>
                        </div>
                        <p className='px-2 text-xl uppercase text-[#a78bfa] font-bold'>You'll gain: </p>
                        ...
                        <div className='p-4 w-full m-2 flex justify-center'>
                            ...
                            <button className='action' onClick={() => setShowCrmModal(true)}>Get started</button>
                        </div>
                        </div>
                        ...
                        {showCrmModal && (
                            ...
                            >
                                <div className="bg-[#242424] p-6 rounded-lg shadow-lg relative w-[80%] max-w-lg" onClick={(e) => e.stopPropagation()}>
                                    <p className='my-2 '>
                                    Fill out the information and we'll contact you to schedule a meeting. We'll discuss your needs and how to create the right system for your business.
                                        </p>
...
export default LayoutMsEn

const benefits = [
    {
        title: "Centralized Member Management",
        text: "Manage registrations, renewals, and communication from a single place.",
        svg: (
            <svg xmlns="http://www.w3.org/2000/svg" className='animate-icons w-[65px] md:w-[80px]' viewBox="0 0 48 48">
    ...
    },
    {
        ...
        text: "Reduce manual work with automated reminders, payments, and reports.",
        svg: (
    ...
    },
    {
        ...
        text: "Enhance the member experience with personalized follow-ups and efficient communication.",
        svg: (
            <svg xmlns="http://www.w3.org/2000/svg" className='animate-icons w-[65px] md:w-[80px]' viewBox="0 0 640 512">
