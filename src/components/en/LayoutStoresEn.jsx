...
import SectionEcommerce from '../ecomm/SectionEcommerce';
import FooterEn from './FooterEn';
import Lighting from '../Lighting';
import useScrollTop from '../hooks/useScrollTop'

const LayoutStoresEn = () => {
    ...
    return (
        ...
        <Lighting>
            ...
            <section className='flex gap-2 uppercase'>
                ...
                How your business can benefit from having a <b className='text-xl md:text-2xl px-1 text-[#a78bfa]'>virtual store</b>?
                </h2>
            </section>
            <section className='grid grid-cols-1 md:grid-cols-2 gap-5 lg:grid-cols-3 px-3'>
                ...
                <h2 className='text-2xl py-4'>You are one step away from  
                    <b className='text-[#a78bfa] px-2'>
                    transforming
                    </b>
                    your business</h2>
                <button className='action' onClick={() => setShowEcommModal(true)}>Get started</button>
            </div>
            ...
            {showEcommModal && (
                ...
                >
                    <div className="bg-[#242424] p-6 rounded-lg shadow-lg relative w-[80%] overflow-y-auto max-w-lg" onClick={(e) => e.stopPropagation()}>
                        <p className='my-2 '>
                        Fill out the information and we'll contact you to schedule a meeting. We'll discuss your needs and how to create your online store that sells.
                            </p>
...
const ecommercebenefits = [
    {
        ...
        text: "Lower costs on rent and maintenance of a physical location, optimizing investment and increasing profitability.",
        svg: (<svg
    ...
    }, 
    {
        ...
        text: "Customers can shop anytime, without time limits, generating constant income.",
        svg: (<svg
            className='animate-icons w-[55px] md:w-[80px]'
    ...
    {
        title: "Greater reach and sales",
        text: "A virtual store allows you to sell to customers anywhere, increasing business opportunities.",
        svg: (<svg
            className='animate-icons w-[55px] md:w-[80px]'
