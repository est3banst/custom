...
const AllServices = () => {
    ...
    const servicesAll = [
        { title : lang === 'en' ? 'Landing Page Development or Single Page Applications' : "Desarrollo de Landing Pages o Aplicaciones de una Sola Página" ,
            benefits :[
                {
                    text: lang === 'en' ? 'Fast loading and smooth experience to attract more customers' : 'Carga rápida y experiencia fluida para atraer más clientes',
                    svg: (<svg
                    ...
                    text: lang === 'en' ? 'Modern design adaptable to all devices' : 'Diseño moderno y adaptable a todos los dispositivos',
                    svg: (<svg
                        className='hover:fill-[#a78bfa] m-auto fill-amber-50 w-[55px] md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {
                    text: lang === 'en' ? 'SEO optimization to improve search engine visibility' : 'Optimización SEO para mejorar la visibilidad en buscadores',
                    svg: (<svg
            ...
            impacts :[
                { text: lang === 'en' ? 'Increases visitor conversion into customers' : 'Aumenta la conversión de visitantes en clientes',
                    svg:(<svg
                ...
                { text: lang === 'en' ? 'Strengthens brand identity with an attractive website' : 'Refuerza la identidad de marca con una web atractiva',
                    svg:(<svg
                        className=' w-[55px] m-auto md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                { text: lang === 'en' ? 'Improves direct communication with the audience' : 'Mejora la comunicación directa con la audiencia',
                    svg:(<svg
                        className='hover:fill-[#a78bfa] m-auto fill-amber-50 w-[55px] md:w-[80px] border-b-[0.5px] border-slate-50'
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        {
            title: lang === 'en' ? 'Development and Implementation of E-commerce' : 'Desarrollo e Implementación de E-commerce',
            benefits: [
                {
                    text: lang === 'en' ? 'Secure and scalable platform for online sales' : 'Plataforma segura y escalable para ventas en línea',
                ...
                {
                    text: lang === 'en' ? 'Integration with payment methods and shipping management' : 'Integración con métodos de pago y gestión de envíos',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" 
                ...
                {
                    text: lang === 'en' ? 'Intuitive design that facilitates purchasing and builds customer loyalty' : 'Diseño intuitivo que facilita la compra y fideliza clientes',
            ...
            impacts: [
                {
                    text: lang === 'en' ? 'Market expansion and increased sales' : 'Expansión del mercado y aumento de ventas',
                ...
                {
                    text: lang === 'en' ? 'Process automation for greater efficiency' : 'Automatización de procesos para mayor eficiencia',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className="hover:fill-[#a78bfa] m-auto fill-amber-50 border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 32 32">
                ...
                {
                    text: lang === 'en' ? '24/7 availability to generate constant income' : 'Disponibilidad 24/7 para generar ingresos constantes',
        ...
        },
        {
            ...
            benefits: [
                {
                    text: lang === 'en' ? 'Performance improvements and faster loading times to prevent customer churn' : 'Mejoras en el rendimiento y menores tiempos de carga para evitar perdidas de clientes',
                ...
                {
                    text: lang === 'en' ? 'Enhanced security to protect data and prevent attacks' : 'Seguridad mejorada para proteger datos y prevenir ataques',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className="fill-amber-50 m-auto hover:fill-[#a78bfa] border-b-[0.5px] border-slate-50 w-[55px] md:w-[80px]" viewBox="0 0 24 24">
                ...
                {
                    text: lang === 'en' ? 'Constant maintenance and updates for stability' : 'Mantenimiento y actualizaciones constantes para estabilidad',
            ...
            impacts: [
                {
                    text: lang === 'en' ? 'Improved user experience, increasing retention' : 'Experiencia de usuario mejorada, aumentando la retención',
                ...
                {
                    text: lang === 'en' ? 'Reduction of errors and failures that affect sales' : 'Reducción de errores y fallos que afectan las ventas',
                ...
                {
                    text: lang === 'en' ? 'Greater reliability and competitiveness in the market' : 'Mayor confiabilidad y competitividad en el mercado',
                    svg: (<svg xmlns="http://www.w3.org/2000/svg" className='hover:fill-[#a78bfa] fill-amber-50 m-auto w-[55px] md:w-[80px]' viewBox="0 0 24 24">
            ...
            buttonText: lang === 'en' ? 'Get support' : 'Obtener soporte',
