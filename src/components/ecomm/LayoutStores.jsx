        ...
        <div className='container max-w-full'>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 gap-5 lg:grid-cols-3 px-3'>
                ...
                <h2 className='text-2xl md:text-3xl lg:text-4xl py-4'>Estás a un paso de 
                 ...
                 tu negocio</h2>
                <button className='action' onClick={() => setShowEcommModal(true)}>Comenzar</button>
            </div>
...
const ecommercebenefits = [
    {
        ...
        text: "Menos gastos en alquiler y mantenimiento de un local físico, optimizando la inversión y aumentando la rentabilidad.",
        svg: (<svg
    ...
    }, 
    {
        ...
        text: "Los clientes pueden comprar en cualquier momento, sin límites de horario, generando ingresos constantes.",
        svg: (<svg
            className='animate-icons w-[55px] md:w-[80px]'
    ...
    {
        title: "Mayor alcance y ventas",
        text: "Una tienda virtual permite vender a clientes de cualquier lugar, aumentando las oportunidades de negocio.",
        svg: (<svg
            className='animate-icons w-[55px] md:w-[80px]'
